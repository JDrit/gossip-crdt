...
public class StatusRequestHandler implements HttpAsyncRequestHandler<HttpRequest> {
    private Peer peer;

    public StatusRequestHandler(Peer peer) {
        this.peer = peer;
    }
    ...
    public void handle(HttpRequest data, HttpAsyncExchange httpExchange, HttpContext context) throws HttpException, IOException {
        ...
        String str = peer.getState().getAllResponse();
